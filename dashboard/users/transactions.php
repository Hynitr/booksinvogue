                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 order-0">
                                <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-6 col-md-6 mb-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <span class="fw-semibold d-block mb-1">Total Book Bought</span>
                                        <h3 class="card-title mb-3">
                                            <?php echo number_format($row['booktoal']) ?></h3>
                                        <a href="./bokshelf"><button class="btn btn-sm btn-outline-primary">View
                                                Books</button></a>
                                    </div>
                                </div>
                            </div>
