...
<body style='text-align: center;'>";
    $body .= "<section style='margin: 30px; margin-top: 50px ; background: #34459C; color: #fff;'>";
        ...
        <br />";
        $body .= "<h3 style='margin-left: 45px; margin-top: 34px; text-align: left; font-size: 17px;'>Kindly use the
            code below to activate your account</h3>
        <br />";
        $body .= "<h1 style='margin-left: 45px; text-align: center;'><b>4578</b></h1>
        <br />";
